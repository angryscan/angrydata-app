Big Data Scanner - кроссплатформенный сканер, выявляющих ценные данные (далее сканер). Сканер запускает на локальной машине и не требуется прав админа для установки.
